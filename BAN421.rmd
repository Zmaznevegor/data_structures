...
#and all countires
g2 <- ggplot(data=plot_c,mapping=aes(x=year))+
...
g2 <- ggplot(data=plot_p,mapping=aes(x=year))+
...
g2 <- ggplot(data=plot_price,mapping=aes(x=year))+
...
Sweden
```{r SE, warning = FALSE, message = FALSE, echo = FALSE}
# Run functions for NORD
# Results are rather disperse
display.hmm(original = comb,
