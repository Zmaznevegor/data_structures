...
setwd("~/NHH Semester I/BAN421 - Data Structures in R/Paper/Project_421/Data")

## 1.Data cleaning process ----

#find the file names of consumption, spot prices and production for each year
consum_names <- list.files(path = "~/NHH Semester I/BAN421 - Data Structures in R/Paper/Project_421/Data", pattern = "consumption-per.*.xlsx", full.names = T)
elspot_names <- list.files(path = "~/NHH Semester I/BAN421 - Data Structures in R/Paper/Project_421/Data", pattern = "elspot.*.xlsx", full.names = T)
production_names <- list.files(path = "~/NHH Semester I/BAN421 - Data Structures in R/Paper/Project_421/Data", pattern = "production-per.*.xlsx", full.names = T)
...
consum_pre<-list.files(path = "~/NHH Semester I/BAN421 - Data Structures in R/Paper/Project_421/Data", 
                           pattern = "consumption-pro.*.xlsx", full.names = T)
consum_pre<-read_xlsx(consum_pre)
produc_pre<-list.files(path = "~/NHH Semester I/BAN421 - Data Structures in R/Paper/Project_421/Data", 
